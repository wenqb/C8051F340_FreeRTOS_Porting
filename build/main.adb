M:main
F:G$_sdcc_external_startup$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0_0$0({2}DF,SI:S),C,0,31,0,0,0
S:Lmain.main$myStr$1_0$135({18}DA18d,SC:U),B,1,14
S:Lmain.main$myStr2$1_0$135({13}DA13d,SC:U),B,1,1
S:Lmain.main$myStrPtr$1_0$135({3}DG,SC:U),R,0,0,[r5,r6,r7]
S:Lmain.main$myStrPtr2$1_0$135({3}DG,SC:U),R,0,0,[]
S:Lmain.main$i$1_0$135({2}SI:U),R,0,0,[r3,r4]
F:G$start_task$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.start_task$pvParameters$1_0$139({3}DG,SV:S),R,0,0,[]
F:G$led0_task$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.led0_task$pvParameters$1_0$141({3}DG,SV:S),R,0,0,[]
F:G$led1_task$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.led1_task$pvParameters$1_0$144({3}DG,SV:S),R,0,0,[]
F:G$led2_task$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.led2_task$pvParameters$1_0$147({3}DG,SV:S),R,0,0,[]
F:G$led3_task$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.led3_task$pvParameters$1_0$150({3}DG,SV:S),R,0,0,[]
T:Fmain$xHeapStats[({0}S:S$xAvailableHeapSpaceInBytes$0_0$0({2}SI:U),Z,0,0)({2}S:S$xSizeOfLargestFreeBlockInBytes$0_0$0({2}SI:U),Z,0,0)({4}S:S$xSizeOfSmallestFreeBlockInBytes$0_0$0({2}SI:U),Z,0,0)({6}S:S$xNumberOfFreeBlocks$0_0$0({2}SI:U),Z,0,0)({8}S:S$xMinimumEverFreeBytesRemaining$0_0$0({2}SI:U),Z,0,0)({10}S:S$xNumberOfSuccessfulAllocations$0_0$0({2}SI:U),Z,0,0)({12}S:S$xNumberOfSuccessfulFrees$0_0$0({2}SI:U),Z,0,0)]
T:Fmain$xSTATIC_EVENT_GROUP[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$xDummy2$0_0$0({12}STxSTATIC_LIST:S),Z,0,0)]
T:Fmain$QueueDefinition[]
T:Fmain$xSTATIC_TIMER[({0}S:S$pvDummy1$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$xDummy2$0_0$0({14}STxSTATIC_LIST_ITEM:S),Z,0,0)({17}S:S$xDummy3$0_0$0({2}SI:U),Z,0,0)({19}S:S$pvDummy5$0_0$0({3}DG,SV:S),Z,0,0)({22}S:S$pvDummy6$0_0$0({2}DC,DF,SV:S),Z,0,0)({24}S:S$ucDummy8$0_0$0({1}SC:U),Z,0,0)]
...
T:Fmain$xSTATIC_LIST_ITEM[({0}S:S$xDummy2$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy3$0_0$0({12}DA4d,DG,SV:S),Z,0,0)]
...
T:Fmain$xSTATIC_TCB[({0}S:S$pxDummy1$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$xDummy3$0_0$0({28}DA2d,STxSTATIC_LIST_ITEM:S),Z,0,0)({31}S:S$uxDummy5$0_0$0({1}SC:U),Z,0,0)({32}S:S$pxDummy6$0_0$0({3}DG,SV:S),Z,0,0)({35}S:S$ucDummy7$0_0$0({8}DA8d,SC:U),Z,0,0)({43}S:S$pxDummy8$0_0$0({3}DG,SV:S),Z,0,0)({46}S:S$ulDummy18$0_0$0({4}DA1d,SL:U),Z,0,0)({50}S:S$ucDummy19$0_0$0({1}DA1d,SC:U),Z,0,0)]
...
T:Fmain$xSTATIC_LIST[({0}S:S$uxDummy2$0_0$0({1}SC:U),Z,0,0)({1}S:S$pvDummy3$0_0$0({3}DG,SV:S),Z,0,0)({4}S:S$xDummy4$0_0$0({8}STxSTATIC_MINI_LIST_ITEM:S),Z,0,0)]
...
T:Fmain$xSTATIC_MINI_LIST_ITEM[({0}S:S$xDummy2$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy3$0_0$0({6}DA2d,DG,SV:S),Z,0,0)]
...
S:G$StartTask_Handler$0_0$0({3}DG,STtskTaskControlBlock:S),F,0,0
S:G$LED0Task_Handler$0_0$0({3}DG,STtskTaskControlBlock:S),F,0,0
S:G$LED1Task_Handler$0_0$0({3}DG,STtskTaskControlBlock:S),F,0,0
S:G$LED2Task_Handler$0_0$0({3}DG,STtskTaskControlBlock:S),F,0,0
S:G$LED3Task_Handler$0_0$0({3}DG,STtskTaskControlBlock:S),F,0,0
...
S:G$_sdcc_external_startup$0_0$0({2}DF,SV:S),C,0,0
S:G$main$0_0$0({2}DF,SI:S),C,0,31
S:Fmain$__str_2$0_0$0({11}DA11d,SC:U),D,0,0
