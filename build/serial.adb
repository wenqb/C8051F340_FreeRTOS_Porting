M:serial
S:Lserial.aligned_alloc$size$1_0$15({2}SI:U),B,1,-4
S:Lserial.aligned_alloc$alignment$1_0$15({2}SI:U),B,1,1
F:G$xSerialPortInitMinimal$0_0$0({2}DF,DG,SV:S),Z,0,4,0,0,0
S:Lserial.xSerialPortInitMinimal$uxQueueLength$1_0$155({1}SC:U),B,1,-3
S:Lserial.xSerialPortInitMinimal$ulWantedBaud$1_0$155({4}SL:U),B,1,1
S:Lserial.xSerialPortInitMinimal$ulReloadValue$1_0$156({4}SL:U),R,0,0,[r7]
S:Lserial.xSerialPortInitMinimal$fBaudConst$1_0$156({4}SF:S),R,0,0,[]
F:G$vSerialISR$0_0$0({2}DF,SV:S),Z,0,2,1,4,0
S:Lserial.vSerialISR$cChar$1_0$159({1}SC:U),B,1,5
S:Lserial.vSerialISR$xHigherPriorityTaskWoken$1_0$159({1}SC:U),B,1,4
S:Lserial.vSerialISR$sloc0$0_1$0({3}DG,SV:S),B,1,1
F:G$xSerialGetChar$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lserial.xSerialGetChar$pcRxedChar$1_0$166({3}DG,SC:S),B,1,-5
S:Lserial.xSerialGetChar$xBlockTime$1_0$166({2}SI:U),B,1,-7
S:Lserial.xSerialGetChar$pxPort$1_0$166({3}DG,SV:S),R,0,0,[]
F:G$xSerialPutChar$0_0$0({2}DF,SC:U),Z,0,-3,0,0,0
S:Lserial.xSerialPutChar$cOutChar$1_0$170({1}SC:S),B,1,-3
S:Lserial.xSerialPutChar$xBlockTime$1_0$170({2}SI:U),B,1,-5
S:Lserial.xSerialPutChar$pxPort$1_0$170({3}DG,SV:S),R,0,0,[]
S:Lserial.xSerialPutChar$xReturn$1_0$171({1}SC:U),R,0,0,[r7]
S:Lserial.xSerialPutChar$sloc0$0_1$0({3}DG,SV:S),B,1,5
F:G$vSerialClose$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lserial.vSerialClose$xPort$1_0$176({3}DG,SV:S),R,0,0,[]
T:Fserial$xHeapStats[({0}S:S$xAvailableHeapSpaceInBytes$0_0$0({2}SI:U),Z,0,0)({2}S:S$xSizeOfLargestFreeBlockInBytes$0_0$0({2}SI:U),Z,0,0)({4}S:S$xSizeOfSmallestFreeBlockInBytes$0_0$0({2}SI:U),Z,0,0)({6}S:S$xNumberOfFreeBlocks$0_0$0({2}SI:U),Z,0,0)({8}S:S$xMinimumEverFreeBytesRemaining$0_0$0({2}SI:U),Z,0,0)({10}S:S$xNumberOfSuccessfulAllocations$0_0$0({2}SI:U),Z,0,0)({12}S:S$xNumberOfSuccessfulFrees$0_0$0({2}SI:U),Z,0,0)]
T:Fserial$xSTATIC_EVENT_GROUP[({0}S:S$xDummy1$0_0$0({2}SI:U),Z,0,0)({2}S:S$xDummy2$0_0$0({12}STxSTATIC_LIST:S),Z,0,0)]
T:Fserial$QueueDefinition[]
T:Fserial$xSTATIC_TIMER[({0}S:S$pvDummy1$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$xDummy2$0_0$0({14}STxSTATIC_LIST_ITEM:S),Z,0,0)({17}S:S$xDummy3$0_0$0({2}SI:U),Z,0,0)({19}S:S$pvDummy5$0_0$0({3}DG,SV:S),Z,0,0)({22}S:S$pvDummy6$0_0$0({2}DC,DF,SV:S),Z,0,0)({24}S:S$ucDummy8$0_0$0({1}SC:U),Z,0,0)]
T:Fserial$xSTATIC_QUEUE[({0}S:S$pvDummy1$0_0$0({9}DA3d,DG,SV:S),Z,0,0)({9}S:S$u$0_0$0({3}ST__00000000:S),Z,0,0)({12}S:S$xDummy3$0_0$0({24}DA2d,STxSTATIC_LIST:S),Z,0,0)({36}S:S$uxDummy4$0_0$0({3}DA3d,SC:U),Z,0,0)({39}S:S$ucDummy5$0_0$0({2}DA2d,SC:U),Z,0,0)]
T:Fserial$__00000000[({0}S:S$pvDummy2$0_0$0({3}DG,SV:S),Z,0,0)({0}S:S$uxDummy2$0_0$0({1}SC:U),Z,0,0)]
T:Fserial$xLIST_ITEM[({0}S:S$xItemValue$0_0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$pvOwner$0_0$0({3}DG,SV:S),Z,0,0)({11}S:S$pvContainer$0_0$0({3}DG,STxLIST:S),Z,0,0)]
T:Fserial$xSTATIC_LIST_ITEM[({0}S:S$xDummy2$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy3$0_0$0({12}DA4d,DG,SV:S),Z,0,0)]
T:Fserial$xMEMORY_REGION[({0}S:S$pvBaseAddress$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$ulLengthInBytes$0_0$0({4}SL:U),Z,0,0)({7}S:S$ulParameters$0_0$0({4}SL:U),Z,0,0)]
T:Fserial$xSTATIC_TCB[({0}S:S$pxDummy1$0_0$0({3}DG,SV:S),Z,0,0)({3}S:S$xDummy3$0_0$0({28}DA2d,STxSTATIC_LIST_ITEM:S),Z,0,0)({31}S:S$uxDummy5$0_0$0({1}SC:U),Z,0,0)({32}S:S$pxDummy6$0_0$0({3}DG,SV:S),Z,0,0)({35}S:S$ucDummy7$0_0$0({8}DA8d,SC:U),Z,0,0)({43}S:S$pxDummy8$0_0$0({3}DG,SV:S),Z,0,0)({46}S:S$ulDummy18$0_0$0({4}DA1d,SL:U),Z,0,0)({50}S:S$ucDummy19$0_0$0({1}DA1d,SC:U),Z,0,0)]
T:Fserial$xSTATIC_STREAM_BUFFER[({0}S:S$uxDummy1$0_0$0({8}DA4d,SI:U),Z,0,0)({8}S:S$pvDummy2$0_0$0({9}DA3d,DG,SV:S),Z,0,0)({17}S:S$ucDummy3$0_0$0({1}SC:U),Z,0,0)]
T:Fserial$tskTaskControlBlock[]
T:Fserial$xLIST[({0}S:S$uxNumberOfItems$0_0$0({1}SC:U),Z,0,0)({1}S:S$pxIndex$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({4}S:S$xListEnd$0_0$0({8}STxMINI_LIST_ITEM:S),Z,0,0)]
T:Fserial$xMINI_LIST_ITEM[({0}S:S$xItemValue$0_0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0_0$0({3}DG,STxLIST_ITEM:S),Z,0,0)]
T:Fserial$xSTATIC_LIST[({0}S:S$uxDummy2$0_0$0({1}SC:U),Z,0,0)({1}S:S$pvDummy3$0_0$0({3}DG,SV:S),Z,0,0)({4}S:S$xDummy4$0_0$0({8}STxSTATIC_MINI_LIST_ITEM:S),Z,0,0)]
T:Fserial$HeapRegion[({0}S:S$pucStartAddress$0_0$0({3}DG,SC:U),Z,0,0)({3}S:S$xSizeInBytes$0_0$0({2}SI:U),Z,0,0)]
T:Fserial$xTASK_STATUS[({0}S:S$xHandle$0_0$0({3}DG,STtskTaskControlBlock:S),Z,0,0)({3}S:S$pcTaskName$0_0$0({3}DG,SC:U),Z,0,0)({6}S:S$xTaskNumber$0_0$0({1}SC:U),Z,0,0)({7}S:S$eCurrentState$0_0$0({1}SC:U),Z,0,0)({8}S:S$uxCurrentPriority$0_0$0({1}SC:U),Z,0,0)({9}S:S$uxBasePriority$0_0$0({1}SC:U),Z,0,0)({10}S:S$ulRunTimeCounter$0_0$0({4}SL:U),Z,0,0)({14}S:S$pxStackBase$0_0$0({3}DG,SC:U),Z,0,0)({17}S:S$usStackHighWaterMark$0_0$0({2}SI:U),Z,0,0)]
T:Fserial$xSTATIC_MINI_LIST_ITEM[({0}S:S$xDummy2$0_0$0({2}SI:U),Z,0,0)({2}S:S$pvDummy3$0_0$0({6}DA2d,DG,SV:S),Z,0,0)]
T:Fserial$xTASK_PARAMETERS[({0}S:S$pvTaskCode$0_0$0({2}DC,DF,SV:S),Z,0,0)({2}S:S$pcName$0_0$0({3}DG,SC:U),Z,0,0)({5}S:S$usStackDepth$0_0$0({2}SI:U),Z,0,0)({7}S:S$pvParameters$0_0$0({3}DG,SV:S),Z,0,0)({10}S:S$uxPriority$0_0$0({1}SC:U),Z,0,0)({11}S:S$puxStackBuffer$0_0$0({3}DG,SC:U),Z,0,0)({14}S:S$xRegions$0_0$0({11}DA1d,STxMEMORY_REGION:S),Z,0,0)]
T:Fserial$xTIME_OUT[({0}S:S$xOverflowCount$0_0$0({1}SC:S),Z,0,0)({1}S:S$xTimeOnEntering$0_0$0({2}SI:U),Z,0,0)]
S:Fserial$uxTxEmpty$0_0$0({1}SC:U),E,0,0
S:Fserial$xRxedChars$0_0$0({3}DG,STQueueDefinition:S),F,0,0
S:Fserial$xCharsForTx$0_0$0({3}DG,STQueueDefinition:S),F,0,0
